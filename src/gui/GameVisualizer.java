/**
 * @brief Класс визуализации игрового процесса
 * @details Отрисовывает робота и цель на игровом поле, обрабатывает пользовательский ввод
 * и обеспечивает плавную анимацию с помощью таймера перерисовки
 */
package gui;
