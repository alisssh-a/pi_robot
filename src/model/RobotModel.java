/**
 * @brief Модель робота для управления его состоянием и движением
 * @details Отслеживает позицию и направление робота, управляет движением к цели
 * с использованием таймера для обновления позиции
 */
package model;
